...
$(document).ready(function (e) {
    ...
    //ConfirMorderSuccess();
    $('#Modal_ConfirMorderSuccess').on('hidden.bs.modal', function (e) {
        GetOrderData();
    })
});
...
var columnDefs = [
    ...
    { headerName: $("#hdn_SupplierStatus").val(), field: "Supplier_Status", tooltip: function (params) { return (params.value); }, width: 40, sortable: true },
    {
    ...
    { headerName: $("#hdn_Offer_Disc_Per").val(), field: "dDisc", tooltip: function (params) { return parseFloat(params.value).toFixed(2); }, width: 70, cellStyle: { color: 'red', 'font-weight': 'bold', 'background-color': '#4abbce73' }, cellRenderer: function (params) { if (params.value != 0) { return parseFloat(params.value).toFixed(2); } }, sortable: true },
    { headerName: $("#hdn_Offer_Value_Dollar").val(), field: "dNetPrice", tooltip: function (params) { return formatNumber(params.value); }, width: 90, cellStyle: { color: 'red', 'font-weight': 'bold', 'background-color': '#4abbce73' }, cellRenderer: function (params) { return formatNumber(params.value); }, sortable: true },
    { headerName: $("#hdn_Final_Disc_Per").val(), field: "Final_Disc", tooltip: function (params) { return formatNumber(params.value); }, width: 70, cellStyle: { color: 'blue', 'font-weight': 'bold', 'background-color': '#fdfdc1' }, cellRenderer: function (params) { if (params.value != 0) { return formatNumber(params.value); } }, sortable: true },
    ...
    {
        headerName: $("#hdn_Assist_1").val(), field: "AssistBy1", hide: true, tooltip: function (params) { return (params.value); }, width: 180, filter: 'agSetColumnFilter'
        , filterParams: {
            values: [],
            resetButton: true,
            applyButton: true
    ...
    { headerName: "SUPP. VALUE", field: "SUPP_BASE_OFFER_VALUE", hide: true, tooltip: function (params) { return formatNumber(params.value); }, width: 100, cellRenderer: function (params) { return formatNumber(params.value); } },
...
const datasource1 = {
    ...
    getRows(params) {
        ...
        $.ajax({
            url: "/ConfirmOrder/GetOrderHistoryData",
            async: false,
            type: "POST",
            data: {
...
function DownloadExcel() {
    ...
    $.ajax({
        url: "/ConfirmOrder/DownloadOrderHistory",
        type: "POST",
        data: {
...
function PlaceConfirmOrder() {
    ...
    if (_.pluck(gridOptions.api.getSelectedRows(), 'iOrderid') != "" && count != 0) {
        ...
        setTimeout(function () {
            ...
            debugger
            $.ajax({
                url: "/ConfirmOrder/CallSupplierApi_Web",
                async: false,
                type: "POST",
                dataType: "json",
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (data.Status == "1") {
                        ...
                        if (data.Data != null && data.Data.length > 0) {
                            tblbody = "<center><table border='1' style='font-size:12px; width:100%; margin-top:5px; display:block; max-height:154px; overflow-y:auto;'>";
                            tblbody += "<thead>";
                            tblbody += "<tr>";
                            tblbody += "<td style='display:none;background-color: #003d66;color: white;padding: 3px;width: 5%;'><center><b>No.</b></center></td>";
                            tblbody += "<td style='background-color: #003d66;color: white;padding: 3px;width: 6%;'><center><b>Stock ID</b></center></td>";
                            tblbody += "<td style='background-color: #003d66;color: white;padding: 3px;width: 17%;'><center><b>Supplier</b></center></td>";
                            tblbody += "<td style='background-color: #003d66;color: white;padding: 3px;width: 4%;'><center><b>Sunrise Status</b></center></td>";
                            tblbody += "</tr>";
                            tblbody += "</thead>";
                            tblbody += "<tbody>";
                            for (var i = 0; i < data.Data.length; i++) {
                                var id = parseInt(i) + 1;
                                tblbody += "<tr>";
                                tblbody += "<td style='display:none;'><center><b>" + id + "</b></center></td>";
                                tblbody += "<td><center><b>" + data.Data[i].RefNo + "</b></center></td>";
                                tblbody += "<td><center>" + data.Data[i].SupplierName + "</center></td>";
                                tblbody += "<td><center>" + data.Data[i].SunriseStatus + "</center></td>";
                                tblbody += "</tr>";
                            }
                            tblbody += "</tbody>";
                            tblbody += "</table></center>";
                            $("#divConfirmList").html(tblbody);
                            $('#Modal_ConfirMorderSuccess').modal('show');
...
var DeleteOrder = function () {
    ...
    if (_.pluck(gridOptions.api.getSelectedRows(), 'iOrderid') != "" && count != 0) {
        ...
        toastr.warning('No stone selected for Delete');
    }
}
var ClearDeleteRemoveModel = function () {
    $("#DeleteModal").modal("hide");
}
function DeleteOrderFinal() {
    var count = 0; count = rowData.length;
    if (_.pluck(gridOptions.api.getSelectedRows(), 'iOrderid') != "" && count != 0) {
        $('.loading-overlay-image-container').show();
        $('.loading-overlay').show();
        ...
        setTimeout(function () {
            ...
            var obj = {};
            obj.iOrderid_sRefNo = iOrderid_sRefNo;

            $.ajax({
                url: "/ConfirmOrder/PurchaseOrder_Delete",
                async: false,
                type: "POST",
                dataType: "json",
                data: JSON.stringify({ req: obj }),
...
function ConfirMorderSuccess() {
    $.ajax({
        url: "/ConfirmOrder/ConfirMorderSuccess",
        async: false,
        type: "POST",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
